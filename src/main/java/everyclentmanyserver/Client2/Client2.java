...
//	private static String basepath= "C:\\Users\\user\\Desktop\\d\\";
//private static String basepath= "C:\\Users\\user\\Desktop\\a\\";
//private static String basepath= "C:\\Users\\user\\Desktop\\d\\";
//	private static String basepath= "C:\\Users\\user\\Desktop\\a\\a\\a\\";
...
//		private static String basePath = "F:\\linux\\nginx\\";
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(60000);//必须要比较大 不然多线程会卡  //60秒会停下来
	...
	public static void sendFile(String filePath) throws Exception {
		...
		if (file.isDirectory())// �ж��Ƿ�Ϊ�ļ���
		{
			if (!filePath.equals(basepath)) {
				mk++;
				ClientThread2 client = new ClientThread2(filePath);
				client.start();
				client.join();
			}
			...
			mk++;
			new ClientThread2(filePath).start();
		}
//		Thread.sleep(50);
//		Thread.sleep(1500);
	}
