...
import everyclentmanyserver.beifen2.Client;
   ...
   /* FileChannel fileChannel = null;
    ...
    public void run() {
        try {
            ...
            sendss(socketChannel, filepath, basepath);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public void sendss(SocketChannel socketChannel, String filepath, String basepath) {
        try {
   ...
   /* @Override
    public void run() {
        ...
        try {
            ...
            socketAddress = new InetSocketAddress("192.168.31.142", 6299);
           // Thread.sleep(1000);
            socketChannel.connect(socketAddress);
