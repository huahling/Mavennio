...
public class NioServer {
   ...
   private NioserverHandler2 nioserverHandler;
   ...
   public NioServer(NioserverHandler2 nioserverHandler) throws IOException, InterruptedException {
            this();
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        new NioServer(new NioserverHandler2());
    }
}
