...
public class NioServer {  Selector selector = null;
    ...
    public NioServer(NioserverHandler handler) throws IOException, InterruptedException {

        this();
        this.handler = handler;

        while (true) {
            int readyChannelsNum = selector.select(3000);//1.2.3,4,1,2,3,12,123,,123,123,123,
